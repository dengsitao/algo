...
//
void mergeSortIntf(int * iArr, int size, int extra){mergeSort(iArr, size);}
void quickSort_exchangeIntf(int * iArr, int size, int extra){quickSort_exchange(iArr, size);}
void quickSort_memcpyIntf(int * iArr, int size, int extra){quickSort_memcpy(iArr, size);}
void bucketSortIntf(int * iArr, int size, int extra){bucketSort(iArr, size);}
void countingSortIntf(int * iArr, int size, int maxvalue){countingSort(iArr, size, MAXRAND);}
void heapSortIntf(int *hArr, int size, int extra){heapSort(hArr, size);}
/////////////////end///////////////////////
